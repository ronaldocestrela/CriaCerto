...
public sealed class TruTestScaleParser : IWeighingScaleFileParser
{
    public ScaleModelEnum ScaleModel => ScaleModelEnum.TruTest;
        ...
        while ((line = reader.ReadLine()) != null)
        {
            ...
            if (rowNumber == 1)
            {
                ...
                for (int i = 0; i < parts.Length; i++)
                {
                    ...
                    if (col is "vid" or "tag" or "eid" or "brinco" or "id" or "visual id") tagIndex = i;
                    else if (col is "weight" or "peso" or "pesokg" or "peso (kg)") weightIndex = i;
                    else if (col is "date" or "data" or "datapesagem") dateIndex = i;
                }
            ...
            {
                rows.Add(new ParsedWeighingRow(rowNumber, "", 0, null, null, "", false, "Linha mal formatada para Tru-Test."));
                continue;
            }
            ...
            {
                rows.Add(new ParsedWeighingRow(rowNumber, "", 0, null, null, "", false, "Identificação do animal (VID/Tag) ausente."));
                continue;
            }
            ...
            rows.Add(new ParsedWeighingRow(rowNumber, tag, weight, weighingDate, null, "Importado via Tru-Test", true, null));
        }
